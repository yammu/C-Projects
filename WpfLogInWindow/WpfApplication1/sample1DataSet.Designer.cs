...
namespace WpfApplication1 {
    ...
    public partial class sample1DataSet : global::System.Data.DataSet {
        ...
        public partial class logInTableDataTable : global::System.Data.TypedTableBase<logInTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public logInTableRow AddlogInTableRow(string name, string username, string password, string emailId) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public logInTableRow FindByname(string name) {
        ...
        public partial class logInTableRow : global::System.Data.DataRow {
            ...
            public string name {
                get {
                    return ((string)(this[this.tablelogInTable.nameColumn]));
                }
                set {
                    this[this.tablelogInTable.nameColumn] = value;
                }
            }
...
namespace WpfApplication1.sample1DataSetTableAdapters {
    ...
    public partial class logInTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[logInTable] WHERE (([name] = @Original_name) AND ([username] =" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[logInTable] ([name], [username], [password], [emailId]) VALUES" +
                " (@name, @username, @password, @emailId);\r\nSELECT name, username, password, emai" +
                "lId FROM logInTable WHERE (name = @name)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[logInTable] SET [name] = @name, [username] = @username, [password] = @password, [emailId] = @emailId WHERE (([name] = @Original_name) AND ([username] = @Original_username) AND ([password] = @Original_password) AND ([emailId] = @Original_emailId));
SELECT name, username, password, emailId FROM logInTable WHERE (name = @name)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WpfApplication1.Properties.Settings.Default.sample1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT name, username, password, emailId FROM dbo.logInTable";
        ...
        public virtual int Fill(sample1DataSet.logInTableDataTable dataTable) {
        ...
        public virtual sample1DataSet.logInTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            sample1DataSet.logInTableDataTable dataTable = new sample1DataSet.logInTableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(sample1DataSet.logInTableDataTable dataTable) {
        ...
        public virtual int Delete(string Original_name, string Original_username, string Original_password, string Original_emailId) {
        ...
        public virtual int Insert(string name, string username, string password, string emailId) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string username, string password, string emailId, string Original_name, string Original_username, string Original_password, string Original_emailId) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string password, string emailId, string Original_name, string Original_username, string Original_password, string Original_emailId) {
            return this.Update(Original_name, username, password, emailId, Original_name, Original_username, Original_password, Original_emailId);
        }
    }
